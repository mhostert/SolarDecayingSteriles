...
print(dNCASCADE)
ax.fill_between(bin_c-dx/2.0, dNCASCADE/dx*1e38,dNCASCADE/dNCASCADE, facecolor='darkgrey',edgecolor='',lw=0.5, linestyle='-',alpha=0.8)
