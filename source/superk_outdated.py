...
def plot_IBD_spectrum(params,fluxfile,xsfile, rasterized=True):
	...
	ax.bar(bin_c, MCall-MCreactor, bottom=MCreactor, lw=0.5, edgecolor='#FFD500', width=dx, label=r'reactors', facecolor='None', hatch='xxxxxxxxxx',
		rasterized=rasterized, zorder=1)
	ax.bar(bin_c,MCreactor-MCreactorLi, bottom=MCreactorLi, lw=0.5, edgecolor='#5BD355', width=dx, label=r'spall ($^9$Li)', facecolor='None', hatch='xxxxxxxxxx',
		rasterized=rasterized, zorder=1)
	ax.bar(bin_c,MCreactorLi, lw=0.5, edgecolor='#5955D8', width=dx, label=r'atm+NC+acc', facecolor='None', hatch='xxxxxxxxxx',
		rasterized=rasterized, zorder=1)
